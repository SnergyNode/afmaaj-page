...
<body data-spy="scroll" data-target="#navbar-example">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                ...
                                <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                                    <h2 class="title1">Amazing Estate Offers </h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">We're In The Business Of Getting Quality Estate & Housing Service</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
                                    <a class="ready-btn page-scroll" href="http://property.afmaaj.co">Learn More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content text-center">
                                ...
                                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <h2 class="title1">Agriculture Everything</h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">Preserving the Green Basket of the Nation</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                <!-- layer 1 -->
                                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <h2 class="title1">Building the Future </h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">Building Lasting and Relaible Structures in the Future</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="well-middle">
                        <div class="single-well">
                            <a href="#">
                                <h4 class="sec-head">Some Title</h4>
                            </a>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero alias saepe modi inventore, dolorem omnis cupiditate, tempore officia deleniti culpa quidem consequatur praesentium voluptatibus, aliquam pariatur. Ut maxime nisi, laboriosam?
                            </p>
                            <ul>
                                <li>
                        ...
                        <div class="about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    <a class="services-icon" href="http://property.afmaaj.co">
                                        <i class="fa fa-home"></i>
                                    </a>
                                    <h4>Real Estate</h4>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque laudantium, accusantium qui voluptatum repellendus.
                                    </p>
                                </div>
                            </div>
                            <!-- end about-details -->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="">
                            <div class="well-text text-center">
                                <h2>Explore Our Real Estate Options</h2>
                                <br>
                                <a href="http://property.afmaaj.co" class="ready-btn ">Explore</a>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="wellcome-text">
                            <div class="well-text text-center">
                                <h2>Stay Updated On Information</h2>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi, ad, dolor.
                                </p>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="testimonial-content text-center">
                            <a class="quate" href="#"><i class="fa fa-comment"></i></a>
    ...
    <!-- End Blog -->
    <!-- Start Suscrive Area -->
    <div id="contact" class="suscribe-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs=12">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="contact-icon text-center">
                            <div class="single-icon">
                                ...
                                <p>
                                    Email: info@afmaaj.co<br>
                                    <span>Web: <a href="http:/afmaaj.co">www.afmaaj.co</a></span>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer-content">
                            <div class="footer-head">
                                ...
                                <div class="footer-contacts">
                                    ...
                                    <p><span>Email:</span> support@afmaaj.co</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright <strong>afmaaj</strong>. All Rights Reserved
                            </p>
                        </div>
                        <div class="credits">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=12321"></script>
